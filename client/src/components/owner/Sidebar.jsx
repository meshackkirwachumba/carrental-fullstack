import { Bus, BusFrontIcon,
   Car, Caravan, CarIcon, Check, Edit, LayoutDashboard, LayoutDashboardIcon, LocateIcon, LocationEditIcon, Truck } from 'lucide-react'
...
const ownerMenuLinks = [
  {
    path:"/owner",
    name:"Dashboard",
    icon1:<LayoutDashboard />,
    icon2:<LayoutDashboardIcon />,
  },
  {
    path:"/owner/add-car",
    name:"Add Car",
      ...
      <div className='w-full'>
        {ownerMenuLinks.map((link, index)=>(
          ...
          py-3 pl-4 first:mt-6 ${link.path === location.pathname ? 'bg-primary/10 text-primary' : 'text-gray-600'}`}>
            {link.path === location.pathname ? link.icon1 : link.icon2}
