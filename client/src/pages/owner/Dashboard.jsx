import { CarFront, List, ListEnd, ListIcon } from 'lucide-react'
...
function Dashboard() {
  ...
  {title: "Total Cars", value:data.totalCars, icon:<CarFront className='h-4 w-4' />},
  {title: "Total Bookings", value:data.totalBookings, icon:<List className='h-4 w-4' />},
  {title: "Pending", value:data.pendingBookings, icon:<IoWarning className='h-4 w-4' />},
  {title: "Confirmed", value:data.completedBookings, icon:<ListIcon className='h-4 w-4' />},
]
